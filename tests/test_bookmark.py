...
class HarvestBookMarkTest(BookmarkTest, HarvestBaseTest):
    ...
    initial_bookmarks = {
        "bookmarks": {
            "projects": {"updated_at": "2022-04-08T06:00:00.000000Z"},
            "time_entries": {"updated_at": "2022-04-08T06:00:00.000000Z"},
            ...
            "tasks": {"updated_at": "2022-04-08T06:00:00.000000Z"},
            "user_projects": {"updated_at": "2022-04-08T06:00:00.000000Z"},
        }
    }
